                        ...
                        if lASList[eachAutoScaler][0].lower() == "vmware vcenter":
                            ...
                            if credRet['result'] == 'success':
                                ...
                                if out["result"] == "success":
                                    ...
                                    if len(pState['off']) > 0:
                                        ...
                                        if lAvergae > v:
                                            ...
                                            if pStatus['result'] == 'success':
                                                ...
                                                sendEmailNewlyAdded(eachAutoScaler, pStatus['vm'], 'poweron', lAvergae, ['dinesh@autointelli.com'])
                                            elif pStatus['result'] == 'no action':
                                                print(" NO ACTION:Send Email Notification for Auto Scale Power ON")
                                                sendEmailNewlyAdded(eachAutoScaler, pStatus['vm'], 'no action', lAvergae, ['dinesh@autointelli.com'])
                                                ...
                                                sendEmailNewlyAdded(eachAutoScaler, '', 'error', lAvergae, ['dinesh@autointelli.com'], pState['data'])
                                    ...
                                    #         pStatus = putPowerOFF(ip, (username, password), pState['on'])
                                    #         if pStatus['result'] == 'success':
