...
for i in dynamicFormExecutionLoc:
    ...
    if creds[dynamicFormExecutionLoc[i]]['type'] == 'pam':
        print(i, dynamicFormExecutionLoc[i], creds[dynamicFormExecutionLoc[i]]['os'], creds[dynamicFormExecutionLoc[i]]['username'])
        ...
        print(i, dynamicFormExecutionLoc[i], creds[dynamicFormExecutionLoc[i]]['os'], creds[dynamicFormExecutionLoc[i]]['username'], creds[dynamicFormExecutionLoc[i]]['password'])
